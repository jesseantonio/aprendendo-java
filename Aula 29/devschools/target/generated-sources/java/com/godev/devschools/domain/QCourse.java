...
public class QCourse extends EntityPathBase<Course> {
    ...
    private static final long serialVersionUID = 557897263L;
    ...
    public final ListPath<StudentCourses, QStudentCourses> students = this.<StudentCourses, QStudentCourses>createList("students", StudentCourses.class, QStudentCourses.class, PathInits.DIRECT2);

    public final QTeacher teacher;

    public final NumberPath<Double> timeCourse = createNumber("timeCourse", Double.class);
